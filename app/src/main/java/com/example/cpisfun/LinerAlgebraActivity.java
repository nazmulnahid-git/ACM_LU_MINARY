...
public class LinerAlgebraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liner_algebra);
        ...
        // Load URL
        webView.loadUrl("https://www.geeksforgeeks.org/matrix/");
    }
}
